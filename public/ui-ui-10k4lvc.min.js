...
Version: 1
Updated: 2023-01-23T10:13:05.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-08-02T15:35:00.000Z
Author: Peter Širka


Component: j-Children
Version: 1
Updated: 2023-01-31T11:03:00.000Z
Author: Peter Širka
...
Component: j-Crop
Version: 1
Updated: 2023-09-08T09:42:00.000Z
Author: Peter Širka
...
Component: j-Extend
Version: 1
Updated: 2023-01-25T13:30:01.000Z
Author: Pete Širka
...
Component: j-Listing
Version: 1
Updated: 2023-01-31T14:44:00.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-02-01T11:19:00.000Z
Author: Peter Širka
...
Component: j-Stats24
Version: 1
Updated: 2023-01-31T12:09:01.000Z
Author: Peter Širka


Component: j-StatsBarSimple
Version: 1
Updated: 2023-01-31T12:04:01.000Z
Author: Peter Širka
...
COMPONENT('display','delay:100',function(self,config,cls){var initialized=false,prev;self.readonly();self.make=function(){self.aclass(cls);self.resizeforce();self.on('resize + resize2',self.resize)};self.resizeforce=function(){var size=WIDTH(self.element);if(!prev||prev.substring(3)!==size){prev&&self.rclass(prev);prev=(M.version<19?'jc-':'d-')+size;self.aclass(prev);self.path&&self.set(size);if(!initialized){initialized=true;self.rclass('invisible hidden')}}};self.resize=function(){setTimeout2(self.ID,self.resizeforce,config.delay)}});
